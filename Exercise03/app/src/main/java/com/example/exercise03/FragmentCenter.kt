...
class FragmentCenter : Fragment(), RadioGroup.OnCheckedChangeListener {
    ...
    override fun onCheckedChanged(group: RadioGroup?, checkedId: Int) {
        ...
        when (checkedId) {
            R.id.radioButtonDog -> {
                myTrans.replace(R.id.fragmentContainerViewDynamic, fragmentDog)
            }

            R.id.radioButtonCat -> {
                myTrans.replace(R.id.fragmentContainerViewDynamic, fragmentCat)
            }
        }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (requireActivity().findViewById(R.id.radioGroup) as RadioGroup).setOnCheckedChangeListener(
            this
        )
    }
